...
const bookTitle = [book.title.trim(), '最新完整章节', '在线免费阅读', book.author?.trim(), '笔趣阁'].filter(Boolean).join('_') + ' - 九天小说站';
