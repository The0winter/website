...
export default function Footer() {
  ...
  return (
    <footer data-site-chrome="true" className={`${['/profile', '/library', '/forum'].includes(pathname) ? 'hidden md:block' : ''} bg-white dark:bg-[#1a1a1a] border-t border-gray-200 dark:border-[#333] transition-colors duration-300 mt-auto`}>
