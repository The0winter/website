...
export default function WriterDashboard({ entry, embedded = false, onExit, onOpenNew, onReady, refreshVersion = 0, onWorksChanged }: { entry: string; embedded?: boolean; onExit?: () => void; onOpenNew?: () => void; onReady?: () => void; refreshVersion?: number; onWorksChanged?: () => void }) {
...
const openBookManager = (book: Book) => {
  ...
  }, [user, authLoading, router, fetchMyData, refreshVersion]);
