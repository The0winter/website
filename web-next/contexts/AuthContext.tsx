...
export function AuthProvider({children}:{children:ReactNode}) {
 ...
 const accept=(user:AuthUser,profile:Profile)=>{setLibraryUser(user.id);setForumUser(user.id);setUser(user);setProfile(profile);localStorage.setItem('novelhub_user',user.id);};
 useEffect(()=>{
