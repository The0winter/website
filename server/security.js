...
export const publicUser = u => ({ id: String(u._id), _id: String(u._id), username: u.username, avatar: u.avatar, profileTheme: u.profileTheme, ...(u.avatarColor ? {avatarColor:u.avatarColor} : {}), role: u.role === 'admin' ? 'admin' : 'reader', created_at: u.created_at, ...(u.isTestAccount ? {isTestAccount:true} : {}) });
