...
http {
 ...
 location /api/ { proxy_pass http://127.0.0.1:5001; proxy_set_header X-Internal-Api-Secret ""; proxy_set_header X-Forwarded-For $remote_addr; proxy_set_header Host $host; proxy_read_timeout 15s; }
 location /health/ { proxy_pass http://127.0.0.1:5001; }
 location / { proxy_pass http://127.0.0.1:3001; proxy_set_header Host $host; proxy_set_header X-Forwarded-For $remote_addr; proxy_read_timeout 15s; }
 }
}`;
