...
while(!stopping){try{console.log(JSON.stringify(await updateStatistics()));}catch(e){console.error('Statistics job failed',e.name);}for(let i=0;i<60&&!stopping;i++)await new Promise(r=>setTimeout(r,1000));}
